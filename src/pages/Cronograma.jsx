...
export const Cronograma = () => {
  ...
  return (
    ...
    <p>¡No te pierdas las actuaciones por día y hora!</p>
    <section>
      <h3 className="text-white">Resumen por escenario</h3>
      <table className="table table-bordered table-striped table-hover align-middle text-center">
        ...
        <tbody>
          <tr><td>Jueves</td><td>18:00</td><td>Principal</td><td>Los Piojos</td></tr>
          <tr><td>Jueves</td><td>20:00</td><td>Escenario Sur</td><td>Conociendo Rusia</td></tr>
          <tr><td>Viernes</td><td>18:00</td><td>Principal</td><td>El Zar</td></tr>
          <tr><td>Viernes</td><td>20:00</td><td>Escenario Norte</td><td>NAFTA</td></tr>
          <tr><td>Sábado</td><td>19:00</td><td>Principal</td><td>Él Mató a un Policía Motorizado</td></tr>
        </tbody>
      </table>
    </section>
  </main>
      ...
      >
		...
		<p className="mb-4">Elige un día para ver los shows disponibles.</p>
        <div className="row justify-content-center mb-4">
          ...
          <div className="col-auto">
            <button
              className={`btn ${
                diaSeleccionado === "18" ? "btn-primary" : "btn-outline-primary"
              } mb-2`}
          ...
          <div className="col-auto">
            <button
              className={`btn ${
                diaSeleccionado === "19" ? "btn-primary" : "btn-outline-primary"
              } mb-2`}
          ...
          <div className="col-auto">
            <button
              className={`btn ${
                diaSeleccionado === "20" ? "btn-primary" : "btn-outline-primary"
              } mb-2`}
          ...
          <div className="col-auto">
            <button
              className={`btn ${
                soloFavoritos ? "btn-success" : "btn-outline-success"
              } mb-2`}
        ...
        <div className="row g-4">
          {showsFiltrados.length === 0 && (
            <p style={{ textAlign: "center" }}>No hay shows para mostrar.</p>
          )}
          {showsFiltrados.map((show) => (
            <div key={show.id} className="col-12 col-md-6">
              ...
              >
                ...
                />
                <div style={{ flex: 1, minWidth: 0 }} className="ms-3">
                  ...
                  <audio controls style={{ marginTop: 8, maxWidth: "100%" }}>
